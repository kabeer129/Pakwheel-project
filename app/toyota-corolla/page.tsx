...
const toyotacorolla = () => {
  return (
    <div className="min-h-screen   flex justify-center items-center">
      <div>
        <h1 className=" bg-blue-950 text-white font-extrabold text-xl sm:text-2xl text-center mb-4 py-4 px-4">
          Toyota Corolla 2024 Price in Pakistan,
        </h1>
        <div className="mb-4 flex justify-center items-center">
          <img
            src="https://di-enrollment-api.s3.amazonaws.com/toyota/models/2024/corolla/Trims/LE_Corolla.png"
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-lg">
          ...
          <ul className="text-sm sm:text-base space-y-2">
            ...
            <li>
              <span className="font-bold">Engine:</span> 1300 CC
            </li>
            <li>
              <span className="font-bold">Condition:</span> 8.5 / 10
            </li>
            <li>
              <span className="font-bold">Driven:</span> 2,500 KM
            </li>
            <li>
        ...
        <div className="mt-6 text-center">
          <p className="text-lg sm:text-xl font-bold text-green-600">PKR 33,00,000</p>
          <a href="payment">
