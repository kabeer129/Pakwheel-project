  ...
  return (
    <div className= " min-h-screen flex justify-center items-center">
      <div>
        ...
        Suzuki Alto 2024 Price in Pakistan,
        </h1>
        <div className="mb-4 flex justify-center items-center">
          <img
            src="https://suzukifortmotors.com/wp-content/uploads/2020/12/Alto-Cerulean-Blue.jpg"
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-lg">
          ...
          <ul className="text-sm sm:text-base space-y-2">
            ...
            <li>
              <span className="font-bold">Driven:</span> 5,500 KM
            </li>
            <li>
              <span className="font-bold">Suspension Type:</span> air Suspension
            </li>
            <li>
              <span className="font-bold">Avg:</span> 15 Km per ltr
            </li>
            <li>
        ...
        <div className="mt-6 text-center">
          <p className="text-lg sm:text-xl font-bold text-green-600">PKR 21,00,000</p>
          <a href="payment">
